    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                ...
                <div class="box-body">
                    <form action="{{ route('admin.mapel.simpan') }}" method="POST" role="form">
                        @csrf
                        <div class="form-group @error('kode') has-error @enderror">
                            <label for="kode">Kode</label>
                            <input type="integer" class="form-control" name="kode" id="kode" value="{{ old('kode') }}">
                        ...
                        <div class="form-group @error('kkm') has-error @enderror">
                            ...
                            <input type="integer" class="form-control" name="kkm" id="kkm" value="{{ old('kkm') }}">
